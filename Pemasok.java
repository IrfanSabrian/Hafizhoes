...
public class Pengguna extends javax.swing.JDialog {
    ...
    public void tampilData() {
        try {
            rs = perintah.executeQuery("SELECT * FROM pemasok");
            model.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pemasok", "Nama Pemasok", "No Telp"
            }
        ) {
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (dataDitemukan == true) {
                ...
                pilihan = JOptionPane.showConfirmDialog(
                        this,
                        "ID Pemasok " + jTextField1.getText() + " sudah ada! "
                ...
                if (pilihan == 0) { // yes
                    try {
                        jTextField2.setText(rs.getString("nama_pemasok"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField1.getText().equals("")) {
            JOptionPane.showMessageDialog(
                    ...
                    "Silahkan lengkapi data ID Pemasok!", // pesannya
            ...
            JOptionPane.showMessageDialog(
                    this, // parent, biasanya this
                    "Silahkan lengkapi data Nama Pemasok!", // pesannya
                    "Informasi", // judul pesan
                    JOptionPane.INFORMATION_MESSAGE // tipe pesan   
            );
            jTextField2.requestFocus();
            ...
            if (modeSimpan == true) { // mode insert
                ...
                if (dataDitemukan == true) {
                    JOptionPane.showMessageDialog(
                            this, // parent, biasanya this
                            "Penyimpanan data Pemasok gagal dilakukan, "
                            + "karena ID Pemasok " + jTextField1.getText()
                    ...
                    try {
                        perintah.execute("INSERT INTO pemasok VALUES('"
                                + jTextField1.getText() + "','"
                                + jTextField2.getText() + "','"
                                + jTextField3.getText() + "')"
                        );
                        ...
                        JOptionPane.showMessageDialog(
                            this, // parent, biasanya this
                            "Penyimpanan data Pemasok gagal dilakukan", // pesannya
                            "Informasi", // judul pesan
                            JOptionPane.INFORMATION_MESSAGE // tipe pesan
                        );
                    }
                ...
                if ((jTable1.getSelectedRow() == -1) && (dataDitemukan == false)) {
                    ...
                    // update data
                    try {
                        perintah.execute("UPDATE pemasok SET "
                                + "nama_pemasok = '" + jTextField2.getText() + "', "
                                + "no_telp = '" + jTextField3.getText() + "' "
                                + "WHERE id_pemasok = '" + jTextField1.getText() + "' "
                        );
                        tampilData();
                    } catch (SQLException e) {
                        System.err.println("Query Error");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if ((jTable1.getSelectedRow() == -1) && (dataDitemukan == false)) {
            ...
            if (pilihan == 0) {
                try {
                    perintah.execute("DELETE FROM pemasok "
                        + "WHERE id_pemasok = '" + jTextField1.getText() + "'"
                    );
                    tampilData();
                } catch (SQLException e) {
                    JOptionPane.showMessageDialog(this,
                               "Tidak bisa dihapus karena sedang digunakan di Pembelian!",
                               "Informasi",
                               HEIGHT);
                }
                bersihData();
