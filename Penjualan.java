...
public class Penjualan extends javax.swing.JDialog {
    ...
    DetPenjualan detPenjualan;

    /**
     * Creates new form 
     */
    public Penjualan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    try {
        ...
        String query = "SELECT DISTINCT tgl_penjualan FROM penjualan";
        ...
        while (rs.next()) {
            model.addElement(rs.getString("tgl_penjualan"));
        }
    ...
    try {
        ...
        String query = "SELECT penjualan.no_nota, " + 
                ...
                "JOIN member ON penjualan.id_member = member.id_member " +
                "WHERE penjualan.tgl_penjualan = '" + selectedDate + "'";
        rs = perintah.executeQuery(query);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No Nota", "User", "Tgl Penjualan", "Member", "Harga Total"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTable1.getSelectedRow() >= 0) {
            ...
            detPenjualan = new DetPenjualan(new javax.swing.JFrame(), true, noNota, hargaTotal, namaPengguna);
            detPenjualan.tampilData(); // Memanggil tampilData pada DetPembelian
            detPenjualan.setVisible(true);
        }
